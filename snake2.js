...
function start() {
	...
	snake.transform.baseVal[0].matrix.f = Math.round(Math.random() * (limit.x.bottom - limit.x.top - starter_size * 2)) + limit.y.top + starter_size
	console.log('y:', snake.transform.baseVal[0].matrix.f)
